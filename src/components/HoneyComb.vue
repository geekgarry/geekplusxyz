<template>
  <div>
    <ul id="hexGrid">
      <li class="hex" v-for="item,index in articleList" :key="index">
        <router-link class="hexIn" :to="'/article/' + item.id">
          <!-- <a href="javascript:void(0);"> -->
            <img
              v-lazy=" item.indexPicture ? item.indexPicture : require('@/assets/img/cover' + someNumberCount(4) + '.jpeg') "
              :alt="item.articleTitle"
            />
            <h1>{{ item.articleTitle ? item.articleTitle : "title" }}</h1>
            <p>
              {{
                item.abstractText
                  ? item.abstractText
      ...
      <li class="hex">
        <a class="hexIn" href="#">
          <img src="/imgs/superSlide/images/11.jpg" alt="" />
      ...
      <li class="hex">
        <a class="hexIn" href="#">
          <img src="/imgs/superSlide/images/22.jpg" alt="" />
          <h1>This is a title</h1>
          <p>Some sample text about the article this hexagon leads to</p>
        </a>
      </li>
      <li class="hex">
        <a class="hexIn" href="#">
          <img src="/imgs/superSlide/images/33.jpg" alt="" />
          <h1>This is a title</h1>
          <p>Some sample text about the article this hexagon leads to</p>
        </a>
      </li>
      <li class="hex">
        <a class="hexIn" href="#">
          <img src="/imgs/superSlide/images/44.jpg" alt="" />
          <h1>This is a title</h1>
          <p>Some sample text about the article this hexagon leads to</p>
        </a>
      </li> -->
...
body {
  background-color: rgb(112, 178, 178);
}
#hexGrid {
  overflow: hidden;
  width: 90%;
