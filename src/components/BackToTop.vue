<template>
  <span>
    <transition :name="transitionName" enter-active-class="animate__bounceIn" 
        leave-active-class="animate__bounceOut">
        <div class="page-component-up" data-toggle="tooltip" data-placement="top" 
            title="返回顶部" @click="backToTop" v-show="visible" :style="customStyle">
...
export default {
    ...
    methods: {
        ...
        backToTop() {
            //document.getElementsByClassName(".page-component-up")[0].tooltip();
