...
export default  {
  ...
  created(){
    ...
    console.log("%chttps://www.xxx.xxx","background-image:-webkit-gradient( linear, left top, right top, color-stop(0, #f22), color-stop(0.15, #f2f), color-stop(0.3, #22f), color-stop(0.45, #2ff), color-stop(0.6, #25e),color-stop(0.75, #4f2), color-stop(0.9, #f2f), color-stop(1, #f22) );color:transparent;-webkit-background-clip: text;font-size:2em;")
    // console.log("%c", "padding:50px 300px;line-height:120px;background:url('https://www.geekplus.xyz/imgs/logo.png') no-repeat;");
    var _this = this;
